    ...
    return (
        <div className=" bg-slate-400 flex flex-col h-screen relative">
            ...
            <header className="p-2 flex gap-3 items-center justify-center w-full bg-white shadow-md shadow-[#00000050] z-20">
                ...
                <button className=" text-white p-3 text-lg h-14 w-14 brightness-75 overflow-hidden bg-contain bg-no-repeat bg-center active:scale-95 transition-all nes-btn is-warning"  onClick={() => {
